...
function venueRandomSeats() {
    ...
    var vue = new Vue({
        ...
        methods: {
            fetchVenueRandomTickets: function () {
                if (!IntCheck(this.seatsNum)) {
                    ...
                    this.$http.get("http://localhost:8080/order/venueRandomSeatOrder/" + quantity).then(function (response) {
...
function hideError() {
    var alertBox = document.getElementById("venueRandomSeatsError");
